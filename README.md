...
[https://github.com/hdfchain/hdfchain-binaries/releases/latest](https://github.com/hdfchain/hdfchain-binaries/releases/latest)
...
Solo mining on mainnet using hdfd running on the local host:
...
```
go get github.com/hdfchain/gominer
cd $GOPATH/src/github.com/hdfchain/gominer
cd gominer
