...
var (
	//kernelDll           = syscall.MustLoadDLL("hdfchain.dll")
	kernelDll               = syscall.MustLoadDLL("hdfchain.dll")
	precomputeTableProcAddr = kernelDll.MustFindProc("hdfchain_cpu_setBlock_52").Addr()
	kernelProcAddr          = kernelDll.MustFindProc("hdfchain_hash_nonce").Addr()
)
